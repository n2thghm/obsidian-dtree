...
export class IconSuggestModal extends SuggestModal<string> {
  private onSelectCallback: (icon: string | null) => void;
  private button: ButtonComponent;

  constructor(app: App, buttonEl: ButtonComponent) {
    super(app);
...
export function attachIconMenu (buttonEl: ButtonComponent) {
  const modal = new IconSuggestModal(this.app, buttonEl)
